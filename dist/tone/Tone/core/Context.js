...
/**
 *  Set a function to determine the time
 */
Tone.Context.prototype.setTimeSource = function(timeFunction){
	this._getTime = timeFunction;
};
...
Tone.Context.prototype.now = function(){
	return this._getTime() + this.lookAhead;
};
