...
Tone.prototype.setTimeSource = function(timeFunction){
	return Tone.context.setTimeSource(timeFunction);
};

Tone.setTimeSource = function(timeFunction){
	return Tone.context.setTimeSource(timeFunction);
};
