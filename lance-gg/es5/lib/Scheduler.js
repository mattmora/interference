...
/**
 * Scheduler class
 * MJW: Updated to take external clock source
 */
...
var Scheduler = function () {
     ...
     */
    // MJW: added getTime function to be passed in
    function Scheduler(options, getTimeFunction) {
    ...
    _createClass(Scheduler, [{
        ...
        value: function nextTickChecker() {
            // MJW: changed currentTime to use passed getTime() function instead of (new Date()).getTime()
        ...
        value: function nextTick() {
            // MJW: changed stepStartTime to use passed getTime() function instead of (new Date()).getTime()
            var stepStartTime = this.getTime();
            ...
            this.requestedDelay = 0;
            setTimeout(this.nextTick.bind(this), this.nextExecTime - this.getTime());
        }
    }, {
        key: 'callTick',
