...
var _InterferenceServerEngine = _interopRequireDefault(require("./server/InterferenceServerEngine"));
...
var gameEngine = new _InterferenceGameEngine.default({
  traceLevel: _lanceGg.Lib.TRACE_NONE
});
var serverEngine = new _InterferenceServerEngine.default(io, gameEngine, {
  debug: {},
  updateRate: 6,
  timeoutInterval: 600
}); // start the game
